...
func (m *defaultUserModel) Insert(ctx context.Context, data *User) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Id, data.Nickname, data.Password, data.Phone, data.Avatar, data.BackgroundImage, data.Signature, data.DeleteTime)
	}, userIdKey, userPhoneKey)
	return ret, err
}
...
func (m *defaultUserModel) Update(ctx context.Context, newData *User) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.Nickname, newData.Password, newData.Phone, newData.Avatar, newData.BackgroundImage, newData.Signature, newData.DeleteTime, newData.Id)
	}, userIdKey, userPhoneKey)
	return err
}
